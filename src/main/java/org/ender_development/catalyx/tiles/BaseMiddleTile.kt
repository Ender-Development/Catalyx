...
open class BaseMiddleTile(override val mod: ICatalyxMod) : BaseTile(mod), IMultiBlockPart {
	override fun activate(world: World, pos: BlockPos, state: IBlockState, player: EntityPlayer, hand: EnumHand, side: EnumFacing, hitX: Float, hitY: Float, hitZ: Float) = false
