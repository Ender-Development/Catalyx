...
interface ICopyPasteExtraTile {
	 ...
	 * Note: if your TE implements BaseGuiTyped.IDefaultButtonVariables (like {@link org.ender_development.catalyx.tiles.BaseMachineTile} does), the `isPaused` and `needsRedstonePower` fields are already copied
	 */
