...
internal class AssignExpr(val name: Token, val value: Expr) : Expr() {
	override fun <R> accept(visitor: ExprVisitor<R>): R {
		return visitor.visitAssignExpr(this)
	}
}

internal class LogicalExpr(val left: Expr, val operator: Token, val right: Expr) : Expr() {
	override fun <R> accept(visitor: ExprVisitor<R>): R {
...
internal class CallExpr(val name: String, val arguments: List<Expr>) : Expr() {
	override fun <R> accept(visitor: ExprVisitor<R>): R {
