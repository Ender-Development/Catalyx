package org.ender_development.catalyx.core.client.button
 ...
 * - make sure your button has a constructor that takes ([x], [y], [width], [height]); ([x], [y]); or (), as that's how your class will be instantiated on server-side (see [org.ender_development.catalyx.core.network.ButtonPacket])
 *
