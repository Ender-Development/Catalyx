...
import org.ender_development.catalyx.api.v1.common.tileentities.interfaces.IItemTile

/**
 * A base Catalyx TileEntity with functions allowing you to create custom machines efficiently
 * Utilizes [org.ender_development.catalyx.core.common.statemachine.StateMachine]
 * TODO: actually adapt the new StateMachine!!!
 */
abstract class MachineTile<T>(mod: ICatalyxMod) : BaseTile(mod), ITickable, IGuiTile, IItemTile, IButtonTile, BaseGuiTyped.IDefaultButtonVariables {
