 ...
 */
open class TileBlock(mod: ICatalyxMod, name: String, val tileClass: Class<out TileEntity>, val guiId: Int) : CBlock(mod, name), ITileEntityProvider {
	/**
	 * Only use this constructor if you used a [CatalyxGuiHandler] for the guiId
	 */
