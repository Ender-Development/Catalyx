...
interface ICatalyxMod {
	 companion object {
		  ...
		  */
		 const val DEPENDENCIES = "required-after:forgelin_continuous@[${Reference.KOTLIN_VERSION},);required-after:mixinbooter@[${Reference.MIXINBOOTER_VERSION},);after:groovyscript@[${Reference.GROOVYSCRIPT_VERSION},);"
