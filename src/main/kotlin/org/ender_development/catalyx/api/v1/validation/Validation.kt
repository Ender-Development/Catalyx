...
object Validation {
	fun newValidationError(field: String? = null, message: String, code: String? = null, severity: Severity = Severity.ERROR): IValidationError =
		ValidationError(field, message, code, severity)
	...
	fun <T> IValidationResult<T>.failure(errors: List<IValidationError>): IValidationResult<T> =
